...
public class ChitietMonAn_lauatisoActivity extends AppCompatActivity {
    MenuChitiet data;
    ...
    private int basePrice = 185000;
    FirebaseFirestore db;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.food_detail_lauatiso);
        ...
        addCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ChitietMonAn_lauatisoActivity.this, CartActivity.class);
